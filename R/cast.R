...
vec_cast.weeknumber <- function(x, to, ...) UseMethod("vec_cast.weeknumber")

#' @method vec_cast.weeknumber default
#' @export
vec_cast.weeknumber.default <- function(x, to, ...) vec_default_cast(x, to)
...
#' @export
vec_cast.character.weeknumber <- function(x, to, ...) format(x)
